...
export default function CreatePassword() {
  ...
  const { getIPRSData, getVerificationData, getAuthenticationData, getUserCreationResponse, updateSignupData, clearSignupData,
     isLoading, getUserCreationData } = useSignupData()
