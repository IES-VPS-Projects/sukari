                        ...
                        <div className="flex items-center gap-3 flex-1">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              <h1 className="text-xl font-semibold text-gray-900">Brown Sugar Import Allocation Approval</h1>
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                              ...
                              <span>Tropical Confectioners Limited</span>
                            </div>
                          </div>
                          ...
                          <div className="space-y-6">
                            ...
                            <div>
                              ...
                              <p className="text-gray-700 leading-relaxed">
                                {action.description} This proposal requires your review and approval to proceed with the sugar import allocation. 
                                The allocation will help stabilize local sugar prices and ensure adequate supply for the domestic market during the upcoming season.
                              </p>
                            </div>
                      ...
                      {activeTab === "activities" && (
                        <div className="h-[350px] overflow-y-auto scrollbar-hide p-6">
                          <div className="space-y-8">
                            ...
                            {/* Q3 - 2024 */}
                            <div>
                              <h3 className="text-lg font-semibold text-gray-900 mb-4">Q3 - 2024</h3>
                              ...
                              <div className="mb-6">
                                <div className="flex items-start gap-3">
                                  ...
                                  <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                      <span className="text-sm font-medium text-gray-900">Sales Returns Filed</span>
                                      <span className="px-2 py-1 bg-purple-100 text-purple-700 text-xs rounded-full">Completed</span>
                                    </div>
                                    <p className="text-sm text-gray-600 mb-2">
                                      Quarterly sales returns submitted for imported brown sugar. Revenue of KES 600M reported.
                                    </p>
                                    <div className="text-xs text-gray-500 space-y-1">
                                      <div>Revenue: KES 600M</div>
                                      <div>Tax Paid: KES 95M</div>
                                      <div>Compliance Status: Verified</div>
                                    </div>
                              ...
                              {/* Previous Import Allocation */}
                              <div className="mb-6">
                                <div className="flex items-start gap-3">
                                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                                  <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                      <span className="text-sm font-medium text-gray-900">Import Allocation Approved</span>
                                      <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded-full">Approved</span>
                                    </div>
                                    <p className="text-sm text-gray-600 mb-2">
                                      Committee approved 12,000 MT brown sugar import allocation for Q3 2024 operations.
                                    </p>
                                    <div className="text-xs text-gray-500 space-y-1">
                                      <div>Approved Quantity: 12,000 MT</div>
                                      <div>Committee Vote: 6-0 (Unanimous)</div>
                                      <div>Delivery: July 2024</div>
                                    </div>
                            ...
                            {/* Q2 - 2024 */}
                            <div>
                              <h3 className="text-lg font-semibold text-gray-900 mb-4">Q2 - 2024</h3>
                              ...
                              <div className="mb-6">
                                <div className="flex items-start gap-3">
                                  ...
                                  <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                      <span className="text-sm font-medium text-gray-900">Compliance Review Completed</span>
                                      <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-full">Passed</span>
                                    </div>
                                    <p className="text-sm text-gray-600 mb-2">
                                      Annual compliance review conducted. Company maintains good standing with all regulatory requirements.
                                    </p>
                                    <div className="text-xs text-gray-500 space-y-1">
                                      <div>Financial Health: Excellent</div>
                                      <div>Import History: Compliant</div>
