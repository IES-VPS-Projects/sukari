      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500">View and manage registered farmers</p>
          </div>
          <Button asChild>
            <Link href="/portal/field-coordinator/farmers/new">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Total of {farmers.length} farmers in the system
            </CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <TableRow key={farmer.id}>
                      ...
                      <TableCell className="text-right">
                        <Button variant="ghost" size="sm" asChild>
                          <Link href={`/portal/field-coordinator/farmers/${farmer.id}`}>
