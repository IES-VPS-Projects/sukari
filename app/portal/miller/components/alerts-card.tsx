...
const alerts: Alert[] = [
  {
    ...
    message: "Your milling license expires on March 15, 2024",
    type: "warning",
    icon: AlertTriangle,
  ...
  },
  {
    ...
    message: "Operating license payment of KES 100,000 is overdue",
    type: "error",
    icon: AlertTriangle,
  ...
  {
    id: 3,
    title: "Compliance Check Scheduled",
    message: "Factory inspection scheduled for January 18, 2024",
    type: "info",
    icon: Calendar,
