  ...
  allAIInsightsData: [
    {
      ...
      description: 'AI suggests optimizing sugar production schedule for 15% efficiency gain',
      timestamp: '2 hours ago',
    ...
    },
    {
      ...
      description: 'Sugar price trends indicate potential 8% increase in Q4',
      timestamp: '4 hours ago',
      category: 'market',
      confidence: 'medium',
      impact: 'high',
    ...
    },
    {
      ...
      description: 'Predictive maintenance suggests servicing Mill 2 within 72 hours',
    ...
    },
    {
      ...
      description: 'Process adjustment recommendation to improve sugar quality by 5%',
      timestamp: '1 day ago',
      category: 'quality',
      confidence: 'medium',
      impact: 'medium',
